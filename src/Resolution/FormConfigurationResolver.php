...
/**
 * @phpstan-type ResolvedForm array{typeClass: class-string<FormTypeInterface>|null, suggestedClass: non-empty-string, fallback: non-empty-string}
 */
readonly class FormConfigurationResolver
{
    /**
